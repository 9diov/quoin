...
import { arbitraryCanonicalPropertyKey, arbitraryNonCanonicalPropertyKey } from './generators.js';
...
describe('Tier 2 — parser properties', () => {
  test.prop([arbitraryCanonicalPropertyKey], { numRuns: 500 })(
  ...
  test.prop([arbitraryNonCanonicalPropertyKey], { numRuns: 500 })(
  ...
  test.prop([fc.string({ maxLength: 50 })], { numRuns: 1000 })(
